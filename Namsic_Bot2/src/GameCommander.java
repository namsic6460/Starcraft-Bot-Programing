...
public class GameCommander {
	...
	public static int createdWorkerCount = 0;
	public static int createdZealotCount = 0;
	public static int createdDragoonCount = 0;
	public static int createdScoutCount = 0;
	public static int nowCarrierCount = 0;
