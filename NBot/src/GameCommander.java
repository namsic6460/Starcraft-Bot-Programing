...
public class GameCommander {
	...
	private int createdForge = 0;
	public static Unit firstForge = null;
	public static Unit secondForge = null;
	public static ArrayList<Unit> dragoons = new ArrayList<>();
	...
	public void onUnitCreate(Unit unit) { 
		...
		if(unit.getType() == UnitType.Protoss_Forge) {
			...
			if(createdForge == 2) {
				secondForge = unit;
				StrategyManager.Instance().upgradePlasma = 1;
			}
		}
		...
		if (type == UnitType.Protoss_Zealot || type == UnitType.Protoss_Dragoon || type == UnitType.Protoss_Carrier)
			StrategyManager.Instance().notConstructed.add(unit);
	}
