...
public class ScoutManager {
	...
	public static Unit currentScoutUnit;
	...
	public static BaseLocation currentScoutTargetBaseLocation = null;
...
//				}
//
//				if (GameCommander.createdWorkerCount >= 11)
//				{
//					System.out.println("!");
//
				...
				for (BaseLocation startLocation : BWTA.getStartLocations()) {
					...
					if (MyBotModule.Broodwar.isExplored(startLocation.getTilePosition()) == false) {
						...
						tempDistance = (double) (InformationManager.Instance()
								.getMainBaseLocation(MyBotModule.Broodwar.self()).getDistance(startLocation) + 0.5);
