...
public class MyBotModule extends DefaultBWListener {
	...
	public void ParseTextCommand(String commandString)
	{
		...
		} else if ("see".equals(commandString)) {
			for(Unit unit : StrategyManager.checked)
				System.out.println(unit.getType());
		} else if ("see2".equals(commandString)) {
			System.out.println(StrategyManager.bases.size());
		}
	}
