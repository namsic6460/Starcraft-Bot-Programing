...
public class MyBotModule extends DefaultBWListener {
	...
	public void ParseTextCommand(String commandString) {
		...
		} else if ("test".equals(commandString)) {
			System.out.println(InformationManager.Instance().getMainBaseLocation(InformationManager.Instance().selfPlayer).getX() + ", " +
					InformationManager.Instance().getMainBaseLocation(InformationManager.Instance().selfPlayer).getY() + ", " + 
					InformationManager.Instance().getMainBaseLocation(InformationManager.Instance().enemyPlayer).getX() + ", " +
					InformationManager.Instance().getMainBaseLocation(InformationManager.Instance().enemyPlayer).getY() + ", " +
					InformationManager.Instance().getFirstChokePoint(InformationManager.Instance().selfPlayer).getX() + ", " +
					InformationManager.Instance().getFirstChokePoint(InformationManager.Instance().selfPlayer).getY() + ", " +
					InformationManager.Instance().getFirstChokePoint(InformationManager.Instance().enemyPlayer).getX() + ", " +
					InformationManager.Instance().getFirstChokePoint(InformationManager.Instance().enemyPlayer).getY() + ", " +
					ScoutManager.Instance().getScoutTargetBaseLocation().getX() + ", " +
					ScoutManager.Instance().getScoutTargetBaseLocation().getY());
		}
	}
